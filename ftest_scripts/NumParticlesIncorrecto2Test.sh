...
../cmake-build-release/fluid/fluid 5 ../files/small_incomplete.fld ../files/small_out.fld 2> "$error_output_file"

# Mensaje de error esperado
expected_error_message="Error: Number of particles mismatch. Header: 4800, Found: 4799"
